...
// Local timezone-safe YYYY-MM-DD (copied from Register.jsx)
...
// Same schema and messages as Register.jsx
...
export default function AdminCreateParent() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      // IMPORTANT: do NOT setToken / setUser here — keep admin logged in
      await api.post('/auth/register', payload);
      nav('/admin/parents'); // or nav('/admin')
    } catch (err) {
    ...
    <div className="min-h-dvh bg-gradient-to-b from-slate-50 to-white flex items-center">
      <div className="mx-auto w-full max-w-md px-4 py-10">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-1 text-sm text-slate-500">Create a parent account and their first child.</p>
