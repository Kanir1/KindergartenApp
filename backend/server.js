...
app.use('/api/daily-reports', dailyReports);    // admin writes; parent/admin read with child access checks :contentReference[oaicite:3]{index=3}
app.use('/api/monthly-reports', monthlyReports);// admin writes; parent/admin read with child access checks :contentReference[oaicite:4]{index=4}
